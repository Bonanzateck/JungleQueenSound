...
import { paylineAssetConfig } from "../../data/payline/paylineconfig";
import {gameRulesAssetConfig} from "../../data/gamerules/gamerulesconfig";
import { leftMeterAssetConfig } from "../../data/leftRevealMeter/leftMeterConfig";
...
let PaylineObject: any = paylineAssetConfig;
for (let key in PaylineObject) {
    loadingGameConfig[key] = PaylineObject[key];
}
...
let gameRulesObject: any = gameRulesAssetConfig;
for (let key in gameRulesAssetConfig) {
    loadingGameConfig[key] = gameRulesObject[key];
}
let leftMeterbject: any = leftMeterAssetConfig;
for (let key in leftMeterbject) {
    loadingGameConfig[key] = leftMeterbject[key];
}
