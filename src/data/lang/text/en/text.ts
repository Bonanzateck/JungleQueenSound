export enum language {
    ...
    //MENU TEXT------------------------------------------------------------------------------------------------------------------------------
    menuText_4 = "PLEASE SELECT YOUR BET:",
    ...
    introductionText_1 = "BUTTERFLY FEATURE",
    introductionText_2 = `Some symbols randomly transform into butterflies,
    starting from the lowest paying one.`,
    introductionText_3 = `After the reels stop, all butterflies change
    into a higher paying symbol that wasn't
    initially transformed when the feature started.`,
    introductionText_5 = "EVERY WIN",
    introductionText_6 = "TRIGGERS A REACTION!",
    introductionText_7 = "WIN UP TO 10.000x\nYOUR TOTAL BET",

    IntroHeading1="BUTTERFLY FEATURE",
    introductiontext_1="Some symbols randomly transform into butterflies, starting from the lowest paying one.",
    introductiontext_2="After the reels stop, all butterflies change into a higher paying symbol that wasn't initially transformed when the feature started.",

    IntroHeading2="GOLDEN QUEEN FEATURE",
    introductiontext_22="Golden Queen Symbols may appear behind the reveal symbols and offer cash prize.",

    //PAYTABLE PAGE TEXT---------------------------------------------------------------
    paytableHeading1 = "PAYTABLE",
    paytableHeading2 = "BUTTERFLY FEATURE",
    paytableHeading3 = "GOLDEN QUEEN SYMBOL",
    paytableHeading4 = "FREE GAME FEATURE",
    paytableHeading5 = "PAYLINES",
    paytableHeading6 = "PAY VALUES",
    paytableHeading7 = "FREE GAME BUY FEATURES",

    paytablePage2_1 = "Payouts shown are dynamic and changing your stake will display the cash returned on each symbol.",
    paytablePage2_2 = "your stake will display the cash returned on each symbol.",
    ...
    firstSlideText22 = "All wins begin with leftmost reel and pay left to right on consecutive reels.\nPayouts shown are dynamic and changing your stake will display the cash returned on each symbol.",
    ...
    thirdSlideText1 = "SYMBOLS",
    paytablePage3_1 = "WILD",
    paytablePage3_2 = "Wild symbols substitute for all other symbols except Scatter symbols and Butterfly symbols.",
    paytablePage3_3 = "BUTTERFLY SYMBOL",
    paytablePage3_4 = "All Butterfly Symbols turn into one of the paying symbols including golden queen symbols..",
    paytablePage3_5 = "SCATTER",
    paytablePage3_6 = "Matching 3 Scatters symbols on reels awards 12 free spins.",
    paytablePage3_7 = "GOLDEN QUEEN SYMBOL",
    paytablePage3_8 = "Golden Queen Symbols may appear behind the Butterfly symbols and offer cash prize.",

    paytablePage4_1 = "The Butterfly feature activates randomly. Some symbols transform into butterflies during the feature, starting from the lowest paying one.This is displayed in the meter. All butterflies on the reels change into a higher paying symbol that wasn't initially transformed when the feature started.",
    paytablePage4_2 = "If two wilds appear on reel 2 & 5 at the same time, then they expand\nand create other Wilds on the reels in between them",


    forthSlideText3 = "If two wilds appear on reel 2 & 5 at the same time, then they expand\nand create other Wilds on the reels in between them.",


    paytablePage5_1 = "Golden Queen Symbols may appear behind the Butterfly Symbols and offer cash prize.",
    paytablePage5_2 = "Getting 4, 5, 6 Scatter symbols will award 12, 14, 16 Free Spins respectively.",




    paytablePage6_1 = "3 scatters trigger 12 free games. Free spins are played in different levels, with the level increasing by collecting butterflies. With each level increase: The next available lowest paying symbol becomes a butterfly for the rest of the game.  3 extra free spins are awarded. The free game multiplier increases by 1x.",
    paytablePage6_2 = "Wild symbols substitute for all other symbols,",
    paytablePage6_3 = "Cost of Freegame Buy Feature is 100x .",
    paytablePage6_4 = "If two wilds appear on reel 2 & 5 at the same time,",


    paytablePage7_1 = "Each spin may have up to 200704 Megaways to win!",
    paytablePage7_2 = "Winning combinations are awarded adjacent left",


    //WIN CELEBRATION-----------------------------------------------------------------------------------------------------------------------------
    winCelebration_bigWin = "",
    ...
    outrotext_2 = 'YOU HAVE WON',
    outrotext_3 = '00',
    outrotext_4 = 'BETTER LUCK NEXT TIME!',

    //FREEGAME TEXT------------------------------------------------------------------------------------------------------------------------------------
    freegameText1 = "FREE GAME",
    freegameText2 = "0",
    freegameText3 = "OUT OF",
    freegameText4 = "12",
    freegameText5 = "TOTAL RETURN",
    freegameText6 = "20500",
    freegameText7 = "MULTIPLIER",
    freegameText8 = "COLLECTED",
    ...
    gameGuideText3_1 = "This game has 6 reels and 10 regular symbols. Wins are evaluated on up to 117649 ways. This means that a sequence of several symbols on consecutive reels – starting from the very left – forms a winning combination regardless of the position on the reel itself. If the symbols appear on a reel multiple times, multiple ways are counted.",
    gameGuideText3_2 = "WILD substitutes for all symbols except Scatter.",

    gameGuideHeading4 = "CAVE REELS",
    gameGuideText4_1 = "Each cave reel adds a symbol to the reel below (Reels 2, 3, 4 and 5).",
    ...
    gameGuideText8_1 = "Fire balls are Free Game Scatters and only appear in cave reels.",
    ...
    gameGuideText9_7 = "If your game is interrupted during a winning spin or a win evaluation, this spin will be recovered after restarting the game.",
    ...
    gameGuideText10_5 = "Click the button with the gear symbol to open a menu in which you can disable and enable options such as turbo spin, full screen, music, etc.",
    ...
    noInternetPopUpText1 = "Message",
    noInternetPopUpText2 = "The internet connection is interrupted. Please restart the game.",
    noInternetPopUpText3 = "Insufficient funds. Please recharge your balance to continue playing.",
    noInternetPopUpText4 = "We could not register any activity from you within the last few minutes. Do you want to continue playing?",
    noInternetPopUpText5 = "An unexpected error has occurred, please restart the game",
    noInternetPopUpText6 = "Response-Time is too long. Please restart the game.",

    //Voucher text---------------------------------------------------------------------------------------------------------------------------------------------------

    //popup
    voucherText1 = "Congratulations!",
    voucherText2 = "You received {x} Free Spins",
    voucherText4 = "Click to start",

    //no-win
    voucherText7 = "Better luck next time!",
    voucherText3 = "You've used your Free Spins Voucher.",
    voucherText5 = "Exit",

    //win
    voucherText8 = "Well Done!",
    voucherText9 = "You've used your Free Spins Voucher and won {x}",

    //reload
    voucherText10 = "Welcome back!",
    voucherText11 = "You have {x} Free Spins to play",
    voucherText6 = "Continue",
    //buy feature------------
    buyFeatureText1 = "BUY FEATURE",
    buyFeatureText_1 = "All unlocked multipliers are awarded.",
    buyFeatureText_12 = "All unlocked multipliers will be awarded.",
    buyFeatureText_11 = "will be charged from your balance.",
}
