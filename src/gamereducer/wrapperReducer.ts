...
const initialState: IApplicationState = {
    betLimit: 0,
    clickToEnterFeature: false,
    disableAutoplay: false, 
    disableCoins: false, 
    hideNegativeWins: false, 
    maximumAutoplay: 0,
    maximumStake: 1, 
    oneClickRules: false, 
...
export const actions = {
    stopButtonVisible: (spinStopButton: boolean): any => ({ type: actionTypes.SHOW_SPIN_STOP_BUTTON, spinStopButton }),
    setUseBuyFeature: (useBuyAFeature: boolean): any => ({ type: actionTypes.SET_USE_BUY_FEATURE, useBuyAFeature }),
    setSpaceBarDisable: (spacebarDisabled: boolean): any => ({ type: actionTypes.SET_SPACEBAR_DISABLE, spacebarDisabled }),
    setOneClickRule: (oneClickRules: boolean): any => ({ type: actionTypes.SET_ONE_CLICK_RULES, oneClickRules }),
    setMaxStake: (maximumStake: number): any => ({ type: actionTypes.SET_MAX_STAKE, maximumStake }),
    setMaxAutoPlay: (maximumAutoplay: number): any => ({ type: actionTypes.SET_MAX_AUTOPLAY, maximumAutoplay }),
    setHideNegativeValue: (hideNegativeWins: boolean): any => ({ type: actionTypes.SET_HIDE_NEGATIVE_VALUE, hideNegativeWins }),
    setDisableCoins: (disableCoins: boolean): any => ({ type: actionTypes.SET_DISABLE_COINS, disableCoins }),
    setDisableAutoplay: (disableAutoplay: boolean): any => ({ type: actionTypes.SET_DISABLE_AUTOPLAY, disableAutoplay }),
    setClickToEnterFeature: (clickToEnterFeature: boolean): any => ({ type: actionTypes.SET_CLICK_TO_ENTER_FEATURE, clickToEnterFeature }),
    setBetLimit: (betLimit: number): any => ({ type: actionTypes.SET_BET_LIMIT, betLimit }),
    showHomeButton: (homeButton: boolean): any => ({ type: actionTypes.SHOW_HOME_BUTTON, homeButton }),
};
